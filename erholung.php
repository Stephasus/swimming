...
<div class="content">
        ...
        <div class="columns is-centered">
            <div class="column link-box">
                <div class="text-table columns">
                    <div class="column erholung-content-wrapper content-wrapper">
                        <div class="erholung-wrapper-1">
                            <h4>Welcome to my World of Swimming</h4>
                        </div>
                        <div class="erholung-wrapper-2">
    ...
    <div class="box">
        <div class="columns is-centered">
            <div class="column link-box">
                <div class="text-table columns">
                    <div class="column erholung-content-wrapper content-wrapper round-edges">
                        <div class="erholung-wrapper-1">
    ...
    <div class="columns is-centered">
        ...
        <div class="column link-box">
            <div class="text-table columns">
                <div class="column erholung-content-wrapper content-wrapper dark-box">
                    <div class="erholung-wrapper-1">
                        <a href="#"><img class="round-edges" src="bildmaterial/Blog/morningroutine_blog.png"></a>
                    </div>
                    <div class="erholung-wrapper-2">
